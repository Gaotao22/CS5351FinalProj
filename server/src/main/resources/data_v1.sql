...
/* tasks id: 1, 2 */
insert into tasks (description, state, comtime, pbi_id) values ('Test Task 1', 2, 1, 2);
insert into tasks (description, state, comtime, pbi_id) values ('Test Task 2', 1, 1, 2);
